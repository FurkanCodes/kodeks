...
export function BrowserWorkspace(props: BrowserWorkspaceProps) {
  ...
  return (
    <section className="relative flex min-h-0 flex-1 flex-col bg-[#09090b]">
      ...
      <div ref={viewportRef} className="relative min-h-0 flex-1 bg-[#08090c]">
        <div className="absolute inset-0 pointer-events-none">
          <div className="flex h-full w-full items-end justify-start p-3">
            <div className="rounded-[8px] bg-black/35 px-2 py-1 text-[10px] text-neutral-400">
              {props.currentUrl || 'No page loaded yet'}
            </div>
          </div>
        </div>
